...
CREATE TABLE enrollments (id SERIAL PRIMARY KEY, user_id INTEGER NOT NULL REFERENCES users, course_id INTEGER NOT NULL REFERENCES courses, entered TIMESTAMP NOT NULL)
